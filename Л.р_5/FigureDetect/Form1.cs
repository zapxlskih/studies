    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < contours.Size; i++)
            {
                ...
                {
                    CvInvoke.PutText(inputImage, "Triangle", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                }
                ...
                if (approximation.Size == 4)
                {
                    ...
                    {
                        CvInvoke.PutText(inputImage, "Square", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                    } else
                    {
                        CvInvoke.PutText(inputImage, "Rectangle", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                    }
                }

                if (approximation.Size == 5)
                {
                    CvInvoke.PutText(inputImage, "Pentagon", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                }

                if (approximation.Size == 6)
                {
                    CvInvoke.PutText(inputImage, "Hexagon", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                }

                if (approximation.Size > 7)
                {
                    CvInvoke.PutText(inputImage, "Circle", new Point(x, y), Emgu.CV.CvEnum.FontFace.HersheyPlain, 2, new MCvScalar(0, 0, 0), 1);
                }
